      ...
      <Navbar className={css.spacer} bg="light" expand="lg">
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="mr-auto">
              <Nav.Link href="#home"><FontAwesomeIcon icon={faPlaneDeparture} /> Recherche de vol</Nav.Link>
              <Nav.Link href="#link"><FontAwesomeIcon icon={faUser} /> Profile & Settings</Nav.Link>
            </Nav>
          </Navbar.Collapse>
        </Navbar>
